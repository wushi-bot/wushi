...
module.exports.run = async (bot, msg, args) => {
  if (args[0] === 'fishingrod') {
    ...
    const embed = new discord.MessageEmbed()
      ...
      .setDescription(`Balance: **${addCommas(Math.floor(eco.get(`${msg.author.id}.balance`)))}** :moneybag: Coins | You can now fish using \`.fish\`.`)
      .setColor('#77e86b')
  ...
  if (args[0] === 'vortex') {
    ...
    const embed = new discord.MessageEmbed()
      ...
      .setDescription(`Balance: **${addCommas(Math.floor(eco.get(`${msg.author.id}.balance`)))}** :moneybag: Coins | You can now create coins from another dimension using \`.vortex\`.`)
      .setColor('#77e86b')
    msg.channel.send(embed)
  }
  if (args[0] === 'farm') {
    ...
    const embed = new discord.MessageEmbed()
      ...
      .setDescription(`Balance: **${addCommas(Math.floor(eco.get(`${msg.author.id}.balance`)))}** :moneybag: Coins | You can now farm using \`.farm\`.`)
      .setColor('#77e86b')
    msg.channel.send(embed)
  }
  if (args[0] === 'provato') {
    ...
    const embed = new discord.MessageEmbed()
      ...
      .setDescription(`Balance: **${addCommas(Math.floor(eco.get(`${msg.author.id}.balance`)))}** :moneybag: Coins | You can now double your output using \`.eat provato\`.`)
      .setColor('#77e86b')
    msg.channel.send(embed)
  }
  if (args[0] === 'gummi') {
    ...
    const embed = new discord.MessageEmbed()
      ...
      .setDescription(`Balance: **${addCommas(Math.floor(eco.get(`${msg.author.id}.balance`)))}** :moneybag: Coins | You can now stop tool durability loss using \`.eat gummi\`.`)
      .setColor('#77e86b')
    msg.channel.send(embed)
  }
  if (args[0] === 'uber') {
    ...
    const embed = new discord.MessageEmbed()
      ...
      .setDescription(`Balance: **${addCommas(Math.floor(eco.get(`${msg.author.id}.balance`)))}** :moneybag: Coins | You can now get Über using \`.eat uber\`.`)
      .setColor('#77e86b')
    msg.channel.send(embed)
  }
  if (args[0] === 'factory') {
    ...
    const embed = new discord.MessageEmbed()
      ...
      .setDescription(`Balance: **${addCommas(Math.floor(eco.get(`${msg.author.id}.balance`)))}** :moneybag: Coins | You can now work using \`.work\`.`)
      .setColor('#77e86b')
    msg.channel.send(embed)
  }
  if (args[0] === 'laptop') {
    ...
    const embed = new discord.MessageEmbed()
      ...
      .setDescription(`Balance: **${addCommas(Math.floor(eco.get(`${msg.author.id}.balance`)))}** :moneybag: Coins | You can now bitmine using \`.code\`.`)
      .setColor('#77e86b')
    msg.channel.send(embed)
  }
  if (args[0] === 'pickaxe') {
    ...
    const embed = new discord.MessageEmbed()
      ...
      .setDescription(`Balance: **${addCommas(Math.floor(eco.get(`${msg.author.id}.balance`)))}** :moneybag: Coins | You can now mine using \`.mine\`.`)
      .setColor('#77e86b')
    msg.channel.send(embed)
  }
}
